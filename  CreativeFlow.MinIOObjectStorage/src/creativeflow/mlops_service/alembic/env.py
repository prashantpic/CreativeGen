...
# Import the base model from your application's models
# This is so that Alembic can find the models to generate migrations
...
def run_migrations_online() -> None:
    ...
    """
    # This line reads the sqlalchemy.url from alembic.ini
    # and overrides it with our function
